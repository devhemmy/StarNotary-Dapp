...
it('lets 2 users exchange stars', async () => {
  ...
  let starId1 = 6;
  let starId2 = 7;
  await instance.createStar('first star 1', starId1, { from: user1 });
  await instance.createStar('sec star 2', starId2, { from: user2 });
...
it('lets a user transfer a star', async () => {
  ...
  let user2 = accounts[2];
  let starId = 9;
  await instance.createStar('Transform test star', starId, { from: user1 });
  await instance.approveBuyer(user2, starId, { from: user1 });
...
it('lookUptokenIdToStarInfo test', async () => {
  ...
  let user = accounts[1];
  let starId = 10;
  await instance.createStar('Star Info', starId, { from: user });
